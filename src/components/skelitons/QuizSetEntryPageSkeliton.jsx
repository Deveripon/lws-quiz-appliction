        ...
        <main className='md:flex-grow px-4 sm:px-6 lg:px-8 py-8'>
            <div>
                ...
                <div className='text-sm mb-4'>
                    ...
                    <div className='h-4 w-16 bg-gray-300 rounded-md mt-2'></div>
                </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 md:gap-8 lg:gap-12'>
                    ...
                    <div>
                        ...
                        <div className='h-6 w-64 bg-gray-200 rounded-md mb-4'></div>
                        <div className='h-4 w-80 bg-gray-200 rounded-md mb-4'></div>
                        ...
                        <div className='space-y-4'>
                            ...
                            {[1, 2, 3, 4].map((_, index) => (
                                <div
                                    key={index}
                                    className='flex items-center space-x-2 px-4 py-2 rounded-md bg-gray-200 animate-pulse'>
                                    <div className='h-4 w-4 bg-gray-300 rounded-full'></div>
                                    <div className='h-4 w-full bg-gray-300 rounded-md'></div>
                                </div>
                            ))}

                            <div className='h-10 w-full bg-gray-300 rounded-md mt-4'></div>
                        </div>
                    </div>
                    ...
                    <div className='space-y-6'>
                        {[1, 2, 3].map((_, index) => (
                            <div
                                ...
                                <div className='flex space-x-4 px-6 py-2 bg-gray-100'>
